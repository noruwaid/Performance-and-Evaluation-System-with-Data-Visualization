...
@foreach ($admincheckbox as $admincheckbox)
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Edit Employee Evaluation</h4>
                  </div>
                  <div class="card-body">
                  <form id="wizard_with_validation" method="POST" action="{{ route('evaluation/update',$admincheckbox->id)}}">
                    @csrf
                      ...
                      <fieldset>
                        <div class="form-group form-float">
                          ...
                          <h5><u>Performance Indicator</u></h5>                            <label>Total Task       :   <b>{{$totaltask}}</b></label><br>
                            ...
                            <label>Late Submission Task     :   <b>{{$latesubmissiontask}}</b></label><br><br>
                        ...
                        <tr>
                          ...
                          @if($admincheckbox->qualityofwork =="1")
                            <input class="form-check-input" type="checkbox" value="1" id="defaultCheck2" name="qualityofwork" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="1" id="defaultCheck2" name="qualityofwork" >
                          @endif
                          </td>
                          <td class="text-center pt-2">
                          @if($admincheckbox->qualityofwork =="2")
                            <input class="form-check-input" type="checkbox" value="2" id="defaultCheck2" name="qualityofwork" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="2" id="defaultCheck2" name="qualityofwork" >
                          @endif                          </td>
                          <td class="text-center pt-2">
                          @if($admincheckbox->qualityofwork =="3")
                            <input class="form-check-input" type="checkbox" value="3" id="defaultCheck2" name="qualityofwork" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="3" id="defaultCheck2" name="qualityofwork" >
                          @endif                          </td>
                          <td class="text-center pt-2">
                          @if($admincheckbox->qualityofwork =="4")
                            <input class="form-check-input" type="checkbox" value="4" id="defaultCheck2" name="qualityofwork" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="4" id="defaultCheck2" name="qualityofwork" >
                          @endif                            </td>
                          <td class="text-center pt-2">                      
                          @if($admincheckbox->qualityofwork =="5")
                            <input class="form-check-input" type="checkbox" value="5" id="defaultCheck2" name="qualityofwork" checked>
                          @else
                      ...
                      <div class="form-group form-float">
                        ...
                        <tr>
                          ...
                          <td class="text-center pt-2">
                          @if($admincheckbox->quantityofwork =="1")
                            <input class="form-check-input" type="checkbox" value="1" id="defaultCheck2" name="quantityofwork" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="1" id="defaultCheck2" name="quantityofwork" >
                          @endif                             </td>
                          <td class="text-center pt-2">
                          @if($admincheckbox->quantityofwork =="2")
                            <input class="form-check-input" type="checkbox" value="2" id="defaultCheck2" name="quantityofwork" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="2" id="defaultCheck2" name="quantityofwork" >
                          @endif                             </td>
                          <td class="text-center pt-2">
                          @if($admincheckbox->quantityofwork =="3")
                            <input class="form-check-input" type="checkbox" value="3" id="defaultCheck2" name="quantityofwork" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="3" id="defaultCheck2" name="quantityofwork" >
                          @endif                             </td>
                          <td class="text-center pt-2">
                          @if($admincheckbox->quantityofwork =="4")
                            <input class="form-check-input" type="checkbox" value="4" id="defaultCheck2" name="quantityofwork" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="4" id="defaultCheck2" name="quantityofwork" >
                          @endif                             </td>
                          <td class="text-center pt-2">                      
                          @if($admincheckbox->quantityofwork =="5")
                            <input class="form-check-input" type="checkbox" value="5" id="defaultCheck2" name="quantityofwork" checked>
                          @else
                      ...
                      <div class="form-group form-float">
                        ...
                        <tr>
                          ...
                          <td>Sara</td>
                          <td class="text-center pt-2">
                          @if($admincheckbox->teamwork =="1")
                            <input class="form-check-input" type="checkbox" value="1" id="defaultCheck2" name="teamwork" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="1" id="defaultCheck2" name="teamwork" >
                          @endif                             </td>
                          <td class="text-center pt-2">
                          @if($admincheckbox->teamwork =="2")
                            <input class="form-check-input" type="checkbox" value="2" id="defaultCheck2" name="teamwork" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="2" id="defaultCheck2" name="teamwork" >
                          @endif                             </td>
                          <td class="text-center pt-2">
                          @if($admincheckbox->teamwork =="3")
                            <input class="form-check-input" type="checkbox" value="3" id="defaultCheck2" name="teamwork" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="3" id="defaultCheck2" name="teamwork" >
                          @endif                             </td>
                          <td class="text-center pt-2">
                          @if($admincheckbox->teamwork =="4")
                            <input class="form-check-input" type="checkbox" value="4" id="defaultCheck2" name="teamwork" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="4" id="defaultCheck2" name="teamwork" >
                          @endif                             </td>
                          <td class="text-center pt-2">                      
                          @if($admincheckbox->teamwork =="5")
                            <input class="form-check-input" type="checkbox" value="5" id="defaultCheck2" name="teamwork" checked>
                          @else
                      ...
                      <div class="form-group form-float">
                          <div class="form-line">
                          <h5><u>Performance Indicator</u></h5>                          <label>Total Task          :   <b>{{$totaltask}}</b></label><br>
                          <label>Total task that needs guidance        :   <b>{{$dependability}}</b></label><br>
                          <label>Needs guidance and complete on time       :   <b>{{$dependabilityontime}}</b></label><br><br>
                        ...
                        <tr>
                          <td>Dependability</td>
                          <td class="text-center pt-2">
                          @if($admincheckbox->dependability =="1")
                            <input class="form-check-input" type="checkbox" value="1" id="defaultCheck2" name="dependability" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="1" id="defaultCheck2" name="dependability" >
                          @endif                             </td>
                          <td class="text-center pt-2">
                          @if($admincheckbox->dependability =="2")
                            <input class="form-check-input" type="checkbox" value="2" id="defaultCheck2" name="dependability" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="2" id="defaultCheck2" name="dependability" >
                          @endif                            </td>
                          <td class="text-center pt-2">
                          @if($admincheckbox->dependability =="3")
                            <input class="form-check-input" type="checkbox" value="3" id="defaultCheck2" name="dependability" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="3" id="defaultCheck2" name="dependability" >
                          @endif                            </td>
                          <td class="text-center pt-2">
                          @if($admincheckbox->dependability =="4")
                            <input class="form-check-input" type="checkbox" value="4" id="defaultCheck2" name="dependability" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="4" id="defaultCheck2" name="dependability" >
                          @endif                            </td>
                          <td class="text-center pt-2">                      
                          @if($admincheckbox->dependability =="5")
                            <input class="form-check-input" type="checkbox" value="5" id="defaultCheck2" name="dependability" checked>
                          @else
                      ...
                      <div class="form-group form-float">
                          ...
                          <label>Attend                    :   <b>{{$attendattendance}}</b></label><br><label>Early                    :   <b>{{$earlyattendance}}</b></label><br>
                        ...
                        <tr>
                          <td>Attendance</td>
                          <td class="text-center pt-2">
                          @if($admincheckbox->attendance =="1")
                            <input class="form-check-input" type="checkbox" value="1" id="defaultCheck2" name="attendance" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="1" id="defaultCheck2" name="attendance" >
                          @endif                             </td>
                          <td class="text-center pt-2">
                          @if($admincheckbox->attendance =="2")
                            <input class="form-check-input" type="checkbox" value="2" id="defaultCheck2" name="attendance" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="2" id="defaultCheck2" name="attendance" >
                          @endif                            </td>
                          <td class="text-center pt-2">
                          @if($admincheckbox->attendance =="3")
                            <input class="form-check-input" type="checkbox" value="3" id="defaultCheck2" name="attendance" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="3" id="defaultCheck2" name="attendance" >
                          @endif                            </td>
                          <td class="text-center pt-2">
                          @if($admincheckbox->attendance =="4")
                            <input class="form-check-input" type="checkbox" value="4" id="defaultCheck2" name="attendance" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="4" id="defaultCheck2" name="attendance" >
                          @endif                            </td>
                          <td class="text-center pt-2">                      
                          @if($admincheckbox->attendance =="5")
                            <input class="form-check-input" type="checkbox" value="5" id="defaultCheck2" name="attendance" checked>
                          @else
                      ...
                      <div class="form-group form-float">
                        ...
                        <tr>
                          <td>Initiative</td>
                          <td class="text-center pt-2">
                          @if($admincheckbox->initiative =="1")
                            <input class="form-check-input" type="checkbox" value="1" id="defaultCheck2" name="initiative" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="1" id="defaultCheck2" name="initiative" >
                          @endif                             </td>
                          <td class="text-center pt-2">
                          @if($admincheckbox->initiative =="2")
                            <input class="form-check-input" type="checkbox" value="2" id="defaultCheck2" name="initiative" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="2" id="defaultCheck2" name="initiative" >
                          @endif                            </td>
                          <td class="text-center pt-2">
                          @if($admincheckbox->initiative =="3")
                            <input class="form-check-input" type="checkbox" value="3" id="defaultCheck2" name="initiative" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="3" id="defaultCheck2" name="initiative" >
                          @endif                            </td>
                          <td class="text-center pt-2">
                          @if($admincheckbox->initiative =="4")
                            <input class="form-check-input" type="checkbox" value="4" id="defaultCheck2" name="initiative" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="4" id="defaultCheck2" name="initiative" >
                          @endif                            </td>
                          <td class="text-center pt-2">                      
                          @if($admincheckbox->initiative =="5")
                            <input class="form-check-input" type="checkbox" value="5" id="defaultCheck2" name="initiative" checked>
                          @else
                      ...
                      <fieldset>
                        <div class="form-group form-float">
                          ...
                          <h5><u>Performance Indicator</u></h5>                          <label>Remarks : <b>{{$adminremarks}}</b></label><br><br>
                            ...
                            <input type="text" class="form-control" value="{{$admincheckbox->remarks}}"name="remarks" required>
                          </div><br><br>
                          <button style="align:right" type="submit" onClick="return confirm('Are you sure to submit?');" class="btn btn-success">Submit</button>
...
@endforeach
@elseif ($role == "sales")
@foreach ($salescheckbox as $sales)
<div class="main-content">
        <section class="section">
          <div class="section-body">              
            <div class="row clearfix">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Edit Employee Performance</h4>
                  </div>
                  <div class="card-body">
                    <form id="wizard_with_validation" method="POST" action="{{ route('evaluation/update',$sales->id)}}">
                    @csrf
                      <input type="hidden" name="role" value="{{$role}}">                      
                      <h3>Planning</h3>
                      <fieldset>
                        ...
                        <tr>
                          ...
                          <td class="text-center pt-2">
                          @if($sales->planning =="1")
                            <input class="form-check-input" type="checkbox" value="1" id="defaultCheck2" name="planning" checked>
                          @else
                          ...
                          <td class="text-center pt-2">
                          @if($sales->planning =="2")
                            <input class="form-check-input" type="checkbox" value="2" id="defaultCheck2" name="planning" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="2" id="defaultCheck2" name="planning" >
                          @endif                          </td>
                          <td class="text-center pt-2">
                          @if($sales->planning =="3")
                            <input class="form-check-input" type="checkbox" value="3" id="defaultCheck2" name="planning" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="3" id="defaultCheck2" name="planning" >
                          @endif                          </td>
                          <td class="text-center pt-2">
                          @if($sales->planning =="4")
                            <input class="form-check-input" type="checkbox" value="4" id="defaultCheck2" name="planning" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="4" id="defaultCheck2" name="planning" >
                          @endif                            </td>
                          <td class="text-center pt-2">                      
                          @if($sales->planning =="5")
                            <input class="form-check-input" type="checkbox" value="5" id="defaultCheck2" name="planning" checked>
                          @else
                      ...
                      <div class="form-group form-float">
                        ...
                        <tr>
                          ...
                          <td class="text-center pt-2">
                          @if($sales->quantityofwork =="2")
                            <input class="form-check-input" type="checkbox" value="2" id="defaultCheck2" name="quantityofwork" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="2" id="defaultCheck2" name="quantityofwork" >
                          @endif                          </td>
                          <td class="text-center pt-2">
                          @if($sales->quantityofwork =="3")
                            <input class="form-check-input" type="checkbox" value="3" id="defaultCheck2" name="quantityofwork" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="3" id="defaultCheck2" name="quantityofwork" >
                          @endif                          </td>
                          <td class="text-center pt-2">
                          @if($sales->quantityofwork =="4")
                            <input class="form-check-input" type="checkbox" value="4" id="defaultCheck2" name="quantityofwork" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="4" id="defaultCheck2" name="quantityofwork" >
                          @endif                            </td>
                          <td class="text-center pt-2">                      
                          @if($sales->quantityofwork =="5")
                            <input class="form-check-input" type="checkbox" value="5" id="defaultCheck2" name="quantityofwork" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="5" id="defaultCheck2" name="quantityofwork" >
                          @endif                            </td>
                      ...
                      <div class="form-group form-float">
                        ...
                        <tr>
                          <td>Communication</td>
                          <td class="text-center pt-2">
                          @if($sales->communication =="1")
                            <input class="form-check-input" type="checkbox" value="1" id="defaultCheck2" name="communication" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="1" id="defaultCheck2" name="communication" >
                          @endif
                          </td>
                          <td class="text-center pt-2">
                          @if($sales->communication =="2")
                            <input class="form-check-input" type="checkbox" value="2" id="defaultCheck2" name="communication" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="2" id="defaultCheck2" name="communication" >
                          @endif                          </td>
                          <td class="text-center pt-2">
                          @if($sales->communication =="3")
                            <input class="form-check-input" type="checkbox" value="3" id="defaultCheck2" name="communication" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="3" id="defaultCheck2" name="communication" >
                          @endif                          </td>
                          <td class="text-center pt-2">
                          @if($sales->communication =="4")
                            <input class="form-check-input" type="checkbox" value="4" id="defaultCheck2" name="communication" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="4" id="defaultCheck2" name="communication" >
                          @endif                            </td>
                          <td class="text-center pt-2">                      
                          @if($sales->communication =="5")
                            <input class="form-check-input" type="checkbox" value="5" id="defaultCheck2" name="communication" checked>
                          @else
                      ...
                      <div class="form-group form-float">
                        ...
                        <tr>
                          ...
                          <td class="text-center pt-2">
                          @if($sales->attendance =="2")
                            <input class="form-check-input" type="checkbox" value="2" id="defaultCheck2" name="attendance" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="2" id="defaultCheck2" name="attendance" >
                          @endif                          </td>
                          <td class="text-center pt-2">
                          @if($sales->attendance =="3")
                            <input class="form-check-input" type="checkbox" value="3" id="defaultCheck2" name="attendance" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="3" id="defaultCheck2" name="attendance" >
                          @endif                          </td>
                          <td class="text-center pt-2">
                          @if($sales->attendance =="4")
                            <input class="form-check-input" type="checkbox" value="4" id="defaultCheck2" name="attendance" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="4" id="defaultCheck2" name="attendance" >
                          @endif                            </td>
                          <td class="text-center pt-2">                      
                          @if($sales->attendance =="5")
                            <input class="form-check-input" type="checkbox" value="5" id="defaultCheck2" name="attendance" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="5" id="defaultCheck2" name="attendance" >
                          @endif                            </td>
                      ...
                      <div class="form-group form-float">
                          ...
                          <label>Total suggestion based on planning: <b>{{$salesinitiative}}</b></label><br><br>
                            <label class="form-label">Initiative*</label>
                            <table class="table table-bordered table-md">
                        <tr>
                          <th>Indicator</th>
                        ...
                        <tr>
                          ...
                          <td class="text-center pt-2">
                          @if($sales->initiative =="2")
                            <input class="form-check-input" type="checkbox" value="2" id="defaultCheck2" name="initiative" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="2" id="defaultCheck2" name="initiative" >
                          @endif                          </td>
                          <td class="text-center pt-2">
                          @if($sales->initiative =="3")
                            <input class="form-check-input" type="checkbox" value="3" id="defaultCheck2" name="initiative" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="3" id="defaultCheck2" name="initiative" >
                          @endif                          </td>
                          <td class="text-center pt-2">
                          @if($sales->initiative =="4")
                            <input class="form-check-input" type="checkbox" value="4" id="defaultCheck2" name="initiative" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="4" id="defaultCheck2" name="initiative" >
                          @endif                            </td>
                          <td class="text-center pt-2">                      
                          @if($sales->initiative =="5")
                            <input class="form-check-input" type="checkbox" value="5" id="defaultCheck2" name="initiative" checked>
                          @else
                           <input class="form-check-input" type="checkbox" value="5" id="defaultCheck2" name="initiative" >
                          @endif                            </td>
                      ...
                      <fieldset>
                        <div class="form-group form-float">
                          ...
                          <h5><u>Performance Indicator</u></h5>                          <label>Remarks : <b>{{$adminremarks}}</b></label><br><br>
                            <label class="form-label">Remarks*</label>
                            <input type="text" class="form-control" value="{{$sales->remarks}}" name="remarks" required>
                          </div>
